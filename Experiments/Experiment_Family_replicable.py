...
for anyclass in all_classes:
    ...
    if anyclass == OWLClass(IRI('http://www.benchmark.org/family#',
                                'Mother')):
        concept = OWLObjectIntersectionOf([
                    OWLClass(IRI(NS, 'Female')),
                    OWLObjectSomeValuesFrom(
                        property=OWLObjectProperty(IRI(NS, 'hasChild')),
                        filler=OWLThing)])
        prediction = 'Female and (hasChild some Thing)'
        individual = OWLNamedIndividual(IRI(NS, 'F9F158'))
        ...
        concept = OWLObjectIntersectionOf([
                    ...
                    OWLObjectSomeValuesFrom(
                        property=OWLObjectProperty(IRI(NS, 'hasChild')),
                        filler=OWLThing)])
        prediction = 'Male and (hasChild some Thing)'
        individual = OWLNamedIndividual(IRI(NS, 'F6M95'))
        ...
        concept = OWLObjectIntersectionOf([
                    OWLClass(IRI(NS, 'Female')),
                    OWLObjectSomeValuesFrom(
                        property=OWLObjectProperty(IRI(NS, 'hasSibling')),
                        filler=OWLThing)])
...
with open('Results_family_replication.csv', 'w', newline='') as output_file:
